...
public class TextureDemoScript : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		if (delta < 1.0f)
		{
            ...
            //Debug.Log("Ah gars on est la");
			// Cast a ray between the stylus and the center of the collider
			RaycastHit[] hits = Physics.RaycastAll(StylusPos, direction);
			...
			// Assign the haptic material settings so that they transition proportionatly
